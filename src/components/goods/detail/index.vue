        ...
        <div class="detail-con">
          ...
          <div class="product-info-path p-course-return">
            ...
            <ul>
              ...
              <li>3、课程升级：需退换课程与被退换课程（课程为在学习未过期状态）为包含关系时，用户需先补足课程间的差价，将课程进行调换，此为升级课程。
                <br>（1）有效期为具体天数型课程，在课程总有效期的50%内，可以申请补差价升级课程。
                <br>（2）有效期为截止日期型课程，在有效期过期前2个月提出申请，可以补差价升级课程。
                <br>（3）课程升级属于一种特殊的退换课形式，根据“退换课只能办理一次规定”，升级后的课程无法再次办理退换。
              </li>
              ...
              <li>6、办理退费时如无法原路退回，需根据客服人员要求提供“身份证正反面复印件、开户行、开户名、账号”等信息，如提供信息不全，将无法办理退费业务。
                <br>注：特殊产品如协议有相关退换课规定以协议为主。
              </li>
            </ul>
          </div>

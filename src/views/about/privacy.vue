  ...
  <div>
    ...
    <div class="about-wrap w">
      <div class="main fr">
        ...
        <div class="section-0">
          <p>道明公司重视用户的隐私。您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。本《隐私政策》与您所使用的道明公司服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。</p>
          <p>您使用或继续使用我们的服务，即意味着同意我们按照本《隐私政策》收集、使用、储存和分享您的相关信息。</p>
          <p>如对本《隐私政策》或相关事宜有任何问题，请通过http://www.webboard.cn/与我们联系。</p>
        </div>
        <!--[if !IE]>|xGv00|3f88f79918cf0ca5370aae3b758afa13<![endif]-->

        <h2 id="infocollect">我们可能收集的信息</h2>
        <div class="section">
          ...
          <ul class="level-1">
            <li>
              ...
              <ul class="level-2">
                <li>
                  <p>
                    <strong>您在注册账户或使用我们的服务时，向我们提供的相关个人信息。</strong>
                  </p>
                  <p>例如电话号码、电子邮件或银行卡号等。</p>
                </li>
                <li>
                  <p>
                    <strong>您通过我们的服务向其他方提供的共享信息，以及您使用我们的服务时所储存的信息。</strong>
                  </p>
                </li>
              </ul>
            </li>
            <li>
              <p>
                <strong>我们在您使用服务时获取的信息</strong>
              </p>
              <ul class="level-2">
                <li>
                  <p>
                    <strong>日志信息。</strong>日志信息指您使用我们的服务时，系统可能通过cookies、web beacon或其他方式自动采集的技术信息，包括：
                  </p>
                  <ul class="level-3">
                    <li>
                    ...
                    <li>
                      <p>(5)您通过我们的服务分享的内容所包含的信息（元数据），例如拍摄或上传的共享照片或录像的日期、时间或地点等。</p>
                    </li>
                    <li>
                      <p>(6)位置信息，指您开启设备定位功能并使用我们基于位置提供的相关服务时，收集的有关您位置的信息，包括：</p>
                    </li>
                    <li>
                      <p>(7)您通过具有定位功能的移动设备使用我们的服务时，通过GPS或WiFi等方式收集的您的地理位置信息；</p>
                    </li>
                    <li>
                      <p>(8)您或其他用户提供的包含您所处地理位置的实时信息，例如您提供的账户信息中包含的您所在地区信息，您或其他人上传的显示您当前或曾经所处地理位置的共享信息，您或其他人共享的照片包含的地理标记信息；</p>
                    </li>
                    <li>
                      <p>(9)您可以通过关闭定位功能，停止对您的地理位置信息的收集。</p>
                    </li>
                  </ul>
                </li>
              </ul>
        ...
        <h2 id="infohowcollect">我们可能如何使用信息</h2>
        <div class="section">
        ...
        <!--[if !IE]>|xGv00|fbf86548c0b85be62b892117e664b42c<![endif]-->

        <h2 id="pinformation">您如何访问和控制自己的个人信息</h2>
        <div class="section">
          <ul class="level-1">
            <li>
        ...
        <!--[if !IE]>|xGv00|ccc998f5b9f528f6c92fc4821f4a7d2a<![endif]-->

        <h2 id="sinformation2">我们可能分享的信息</h2>
        <div class="section">
          ...
          <ul class="level-1">
            <li>
              <ul class="level-2">
                <li>
                  <p>1 我们以及我们的关联公司，可能将您的个人信息与我们的关联公司、合作伙伴及第三方服务供应商、承包商及代理（例如代表我们发出电子邮件或推送通知的通讯服务提供商、为我们提供位置数据的地图服务供应商）分享（他们可能并非位于您所在的法域），用作下列用途：</p>
                </li>
                <li>
                  <p>2 向您提供我们的服务；</p>
                </li>
                <li>
                  <p>3 实现“我们可能如何使用信息”部分所述目的；</p>
                </li>
                <li>
                  <p>4 履行我们在本《隐私政策》中的义务和行使我们的权利；</p>
                </li>
                <li>
                  <p>5 理解、维护和改善我们的服务。</p>
                </li>
            ...
            <li>
              ...
              <ul class="level-2">
                ...
                <li>
                  <p>4 为遵守适用的法律法规、维护社会公共利益，或保护我们的客户、我们、其他用户或雇员的人身和财产安全或合法权益所合理必需的用途。</p>
                </li>
              </ul>
            </li>
          </ul>
        </div>
        <!--[if !IE]>|xGv00|9318ff319007f47f3f34fd037cfadcd5<![endif]-->

        <h2 id="security">信息安全</h2>
        <div class="section">
        ...
        <!--[if !IE]>|xGv00|a97c928dfa5af86dc8faba2d34dc9eb4<![endif]-->

        <h2 id="security">您分享的信息</h2>
        <div class="section">
        ...
        <h2 id="sinformation2">我们可能如何收集信息</h2>
        <div class="section">
        ...
        <div class="section">
          ...
          <ul class="level-1">
            <li>
              <ul class="level-2">
                <li>
                  <p>1 我们的商品或服务，我们的关联公司和合作伙伴的商品或服务，包括即时通讯服务、网上媒体服务、互动娱乐服务、社交网络服务、付款服务、互联网搜索服务、位置和地图服务、应用软件和服务、数据管理软件和服务、网上广告服务、互联网金融，以及其他社交媒体、娱乐、电子商务、资讯和通讯软件或服务（统称“互联网服务”）；</p>
                </li>
                <li>
        ...
        <h2 id="security">我们可能向您发送的邮件和信息</h2>
        <div class="section">
          <p>邮件和信息推送</p>
        ...
        <h2 id="sinformation2">隐私政策的适用例外</h2>
        <div class="section">
        ...
        <h2 id="juvenile">未成年人使用我们的服务</h2>
        <div class="section">
          <p>我们鼓励父母或监护人指导未满十八岁的未成年人使用我们的服务。我们建议未成年人鼓励他们的父母或监护人阅读本《隐私政策》，并建议未成年人在提交的个人信息之前寻求父母或监护人的同意和指导。</p>
        </div>
        <!--[if !IE]>|xGv00|5276e343bf6741a0cffe22673ac85ee0<![endif]-->

        <h2 id="range">隐私政策的适用范围</h2>
        <div class="section">
        ...
        <div class="section">
          <p>
            ...
            <strong>如该等修订造成您在本《隐私政策》下权利的实质减少，我们将在修订生效前通过在主页上显著位置提示或向您发送电子邮件或以其他方式通知您。在该种情况下，若您继续使用我们的服务，即表示同意受经修订的本《隐私政策》的约束。</strong>
          </p>
        </div>
        <!--[if !IE]>|xGv00|377e965496918bcdc6d22e3ad8fd4c8e<![endif]-->
      </div>
    </div>
  </div>
</template>
